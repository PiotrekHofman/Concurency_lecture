...
% pdfLaTeX-compatible UTF-8 setup
...
\newcommand{\okmark}{\textcolor{greenreview}{\textbf{[OK]}}}
\newcommand{\warn}{\textcolor{redreview}{\textbf{[!]}}}

% Lightweight replacements for tcolorbox environments.
% They use only standard minipages, so no special box package is needed.
\newenvironment{summarybox}
  {\par\medskip\noindent\begin{center}\begin{minipage}{0.94\textwidth}\small}
  {\end{minipage}\end{center}\medskip}
\newenvironment{reviewbox}
  {\par\medskip\noindent\begin{center}\begin{minipage}{0.94\textwidth}\small\textcolor{redreview}{\rule{\linewidth}{0.5pt}}\par\smallskip}
  {\par\smallskip\textcolor{redreview}{\rule{\linewidth}{0.5pt}}\end{minipage}\end{center}\medskip}
\newenvironment{tipbox}
  {\par\medskip\noindent\begin{center}\begin{minipage}{0.94\textwidth}\small\textcolor{teal}{\rule{\linewidth}{0.5pt}}\par\smallskip}
  {\par\smallskip\textcolor{teal}{\rule{\linewidth}{0.5pt}}\end{minipage}\end{center}\medskip}

\newenvironment{timing}
...
\subsection{Punkty do omówienia}
\begin{itemize}
\item Ukrycie akcji wewnętrznych i relacja $\overset{a}{\Rightarrow}=\xrightarrow{\tau *}\xrightarrow{a}\xrightarrow{\tau *}$.
